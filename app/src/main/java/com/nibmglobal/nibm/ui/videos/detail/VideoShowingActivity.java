package com.nibmglobal.nibm.ui.videos.detail;
 ...
 */
public class VideoShowingActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (isNetworkAvailable()){
                ...
                String html = "<html><body><iframe src=\"video_link\" width=\"50%\" height=\"50%\" frameborder=\"0\" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></body></html>";
...
//                String html = "<html><body><iframe src=\"https://player.vimeo.com/video/147356726\" width=\"500\" height=\"281\" frameborder=\"0\" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>\n</body></html>";
                ...
                mWebView.loadData(html.replaceAll("video_link", this.video.getVideoUrl()), "text/html", "utf-8");

 ...
 */
public class BatchProfileAdapter extends RecyclerView.Adapter<BatchProfileAdapter.ProfileViewHolder> {

    private Context context;
    private ArrayList<String> list;
    private List<String> types;

    public BatchProfileAdapter(Context context, ArrayList<String> list, List<String> types) {

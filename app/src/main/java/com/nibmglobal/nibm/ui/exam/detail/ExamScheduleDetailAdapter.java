 ...
 */
public class ExamScheduleDetailAdapter extends RecyclerView.Adapter<ExamScheduleDetailAdapter.ViewHolder_> {

    private Context context;
    private ArrayList<String> list;
    private List<String> types;

    public ExamScheduleDetailAdapter(Context context, ArrayList<String> list, List<String> types) {

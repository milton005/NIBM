...
public class CountryAdapter extends BaseAdapter{
	...
	private List<SuppotCountry> list ;
	Context _activity;
	LayoutInflater inflator;



	public CountryAdapter(Context activity, List<SuppotCountry> region_list) {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		view_holdr.tv_option.setText(list.get(arg0).getCountryName());
		view_1.setTag(R.id.txt_item, list.get(arg0).getCountryId());
	...
	public View getDropDownView(int position, View convertView, ViewGroup parent) {
		...
		view_holdr.tv_option.setText(list.get(position).getCountryName());
		view_1.setTag(R.id.txt_item, list.get(position).getCountryId());

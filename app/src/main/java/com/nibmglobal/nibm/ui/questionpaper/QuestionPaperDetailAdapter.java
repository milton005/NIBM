 ...
 */
public class QuestionPaperDetailAdapter extends RecyclerView.Adapter<QuestionPaperDetailAdapter.MyViewHolder> {
    ...
    public QuestionPaperDetailAdapter(Context context, ArrayList<String> list, List<String> types) {
